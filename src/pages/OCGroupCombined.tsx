...
export default function OCGroupCombined() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 mb-6">OC Group Combined</h2>
        ...
        <div className="p-4">
          <form
            onSubmit={async (e) => {
              ...
              const { bids: b } = await bidsApi.list({ date, marketId: marketId ? Number(marketId) : undefined, status: gameType !== 'all' ? gameType : undefined }).catch(() => ({ bids: [] as ApiBid[], total: 0 }))
