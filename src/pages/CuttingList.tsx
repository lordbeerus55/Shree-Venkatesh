...
export default function CuttingList() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Cutting List</h2>
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="p-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-800">Cutting List</h3>
        </div>
        <div className="p-4">
          <form
            onSubmit={async (e) => {
        ...
        {results && (
          <div className="p-4 border-t border-gray-200 overflow-x-auto">
            {bids.length === 0 ? <p className="text-sm text-gray-500">No bids found.</p> : (
